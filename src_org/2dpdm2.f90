...
double precision, dimension(NX,NY)         :: RHS, U, V, P, X, Y, DFUNC
...
call gen_grid(nx, ny, xlen, ylen, X, Y)
call end_watch(1, nWatch, stop_watch)


call begin_watch(2, nWatch, stop_watch)
call PDM_profile(nx, ny, IA, IB, JA, JB, CDD, PFUNC, DFUNC)
...
call init_Arrays(nx, ny, nz, nstep, UU, VV, PP, UAVE, VAVE, UUIN, VVIN, HW, HWAVE)
...
IF (ICON==1)THEN
  ...
  call read_rst_Data(nx, ny, time, UU, VV, PP)
...
!--------------------------------------------------------
  ...
  DO LOOP=1,ITER
    ...
    !call Poisson_AXB(nx, ny, dx, dy, omega, err, RHS, PP)
    call Poisson_AXB2C(nx, ny, dx, dy, omega, err, RHS, PP)
...
!--------------------------------------------------------
  ...
  call accumVars(nx, ny, UU, VV, UAVE, VAVE)
...
! *********************************************
  subroutine gen_grid(nx, ny, xlen, ylen, X, Y)
...
! ***********************************************************************
  subroutine PDM_profile(nx, ny, IA, IB, JA, JB, CDD, PFUNC, DFUNC)
...
! **************************************************************************************************
  subroutine init_Arrays(nx, ny, nz, nstep, UU, VV, PP, UAVE, VAVE, UUIN, VVIN, HW, HWAVE)
...
! **************************************************
  subroutine read_rst_Data(nx, ny, time, UU, VV, PP)
...
! ********************************************
  subroutine store_vel(nx, ny, UO, VO, UU, VV)
...
! *********************************************
  subroutine store_vel3(nx, ny, UO, VO, UU, VV)
...
! *********************************************************************
  subroutine uflux(nx, ny, dt, rei, dx, dy, UO, VO, UU, DFUNC)
...
! *********************************************************************
  subroutine vflux(nx, ny, dt, rei, dx, dy, UO, VO, VV, DFUNC)
...
! *******************************************************
  subroutine Poisson_RHS(nx, ny, dt, dx, dy, RHS, UU, VV)
...
! *********************************************************************
  subroutine Poisson_AXB(nx, ny, dx, dy, omega, err, RHS, PP)
...
! *********************************************************************
  subroutine Poisson_AXB2C(nx, ny, dx, dy, omega, err, RHS, PP)
...
! **************************************************
  subroutine Prj_Vel(nx, ny, dt, dx, dy, UU, VV, PP)
...
! ***************************************************************************
  subroutine BC_Vel(nx, ny, dt, dx, dy, nstep, istep, UU, VV, UO, UUIN, VVIN)
...
! *********************************************
  subroutine stg2Node(nx, ny, U, V, UAVE, VAVE)
...
! ************************************************
  subroutine accumVars(nx, ny, UU, VV, UAVE, VAVE)
...
! *******************************************************************
  subroutine wrt_RCSIns(nx, ny, nz, istep, time, A, U, V, HU, HV, HW)
...
! **************************************************************
!  subroutine wrt_VisIns(nx, ny, nz, istep, time, A, HU, HV, HW)
...
! *************************************************************************
  subroutine wrt_SPHIns(nx, ny, nz, dx, dy, istep, time, U, V, P, HUVW, HP)
...
! **********************************************
  subroutine avr_Vars(nx, ny, nstep, UAVE, VAVE)
...
! ************************************
  subroutine wrt_Profile(nx, ny, UAVE)
...
! **********************************************************************************
  subroutine wrt_RCSAvr(nx, ny, nz, time, nstep, UAVE, VAVE, A, HUAVE, HVAVE, HWAVE)
...
! ************************************************************************
  subroutine wrt_SPHAvr(nx, ny, nz, dx, dy, istep, time, UAVE, VAVE, HUVW)
